...
7. 必须先识别真实地面、主墙、地毯/茶几/电视墙/窗户/门洞/通道关系，把沙发放在最合理的客厅座位区，而不是随机居中或随意摆放。
8. 沙发落位必须满足室内设计常识：如果房间参考图已有沙发/座椅，可以用商品沙发替换原有可移动座位家具；有电视墙/媒体墙时，沙发朝向应符合观看和会客逻辑，不能让电视墙突然换边或朝向窗户。
9. 沙发必须贴合地面透视，底座/脚部有明确接触点、接触阴影和投射阴影；不能悬浮、穿墙、压在不合理家具上或比例过大过小。
10. 可以选择沙发正面、侧面或45度斜侧等更适合产品展示的角度，但必须像摄影师在同一个真实房间里移动机位拍摄，不能因此改变电视墙、窗户、门洞和墙体的相对关系。
11. 远景/中景/近景必须通过真实摄影机距离、焦段、机位高度、景深和裁切范围来区分，不能只把沙发简单放大或缩小：
...
13. 光影、比例、透视、地面接触关系必须真实，避免悬浮感、抠图感和塑料质感。
`,
    });
