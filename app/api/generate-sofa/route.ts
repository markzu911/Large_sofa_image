...
3. 沙发落位优先级：
   ...
   - 有电视墙、媒体墙、壁炉墙或主背景墙时，沙发必须按观看/会客逻辑落位：放在电视/媒体墙对侧或斜对侧的可用地面上，座面朝向电视/媒体墙，长边与电视墙大致平行，保持合理观看距离。
...
4. 位置合理性强于画面居中：宁可让沙发偏右、偏左或偏下，也不能为了居中构图把大沙发摆到窗前、电视前、门口、走道中央或柜体前方。
5. 必须按房间透视缩放沙发大小，近大远小；底座必须贴合地面透视线，不能悬浮、歪斜、穿墙或压在不合理物体上。
6. 必须生成沙发的真实接触阴影和投射阴影，阴影方向、软硬程度和长度要与房间光源一致，绝不能有生硬抠图感。
7. 沙发本身的受光方向、高光、阴影必须与房间参考图中的光源方向完全吻合。
8. 当前设置：
   - 景别类型: ${shotName}
   - 摄影机参数: ${cameraSpec}
   - 生成视角: ${angle}
