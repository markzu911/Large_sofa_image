...
8. 必须执行空间规划检查清单：先识别不可移动结构，包括电视/媒体墙、主背景墙、大窗/窗帘、门洞、阳台门、固定柜体、墙角、地面透视和主要通道；再标记禁放区，包括窗前采光区、门洞/通道、电视墙正前方、固定柜体前、墙体开口、过窄地面和会导致沙发漂浮/穿墙的位置；再标记可放区，包括原沙发/座椅区、地毯/茶几会客区、电视/媒体墙对侧或斜对侧的开阔地面、不会挡光挡路的空地；最后从可放区中选择最符合观看/会客逻辑的位置，不能从画面中心或商品角度倒推落位。
9. 沙发落位必须满足室内设计常识：如果房间参考图已有沙发/座椅，可以用商品沙发替换原有可移动座位家具；有电视墙/媒体墙时，沙发必须放在电视/媒体墙对侧或斜对侧的可用地面上，座面朝向电视/媒体墙，保持合理观看距离。
10. 如果电视在画面左/右侧墙，大窗在后墙，沙发不能横在大窗前或房间中轴线上堵住采光；应退到电视对侧的下方/侧方开阔地面，朝向电视，保留窗前通道和视觉空白。
11. 如果窗前是主要采光面、阳台门或明显通道，禁止把大沙发背靠或横放在窗前，除非房间参考图原本就有不遮挡窗主体的窗前座位区。
12. 位置合理性强于画面居中：宁可让沙发偏右、偏左或偏下，也不能为了居中构图把大沙发摆到窗前、电视前、门口、走道中央或柜体前方。
13. 沙发必须贴合地面透视，底座/脚部有明确接触点、接触阴影和投射阴影；不能悬浮、穿墙、压在不合理家具上或比例过大过小。
14. 可以选择沙发正面、侧面、背侧或斜侧等更适合产品展示的角度；角度不固定，合理即可，但必须像摄影师在同一个真实房间里移动机位拍摄，不能因此改变沙发落位、电视墙、窗户、门洞和墙体的相对关系。
15. 远景/中景/近景都必须先完成房间结构识别和合理沙发落位，再通过真实摄影机距离、焦段、机位高度、景深和裁切范围来区分，不能只把沙发简单放大或缩小，更不能为了景别改变沙发落位或房间构造：
...
16. 不要把大沙发摆在大窗正前方或房间中央来挡住采光和通道；不要为了拍到沙发正面而把电视墙、窗户、门洞或墙体关系换边；不要让沙发面向窗户却背离已有电视/媒体墙，除非房间参考图明确没有电视/媒体墙；不要因为远景/中景/近景任一景别要求而牺牲合理落位；不要把拍摄角度理解为固定角度命令，角度可以变化，沙发位置和房间结构不能为角度让路。
17. 如果用户只用文字描述，就按文字生成高端家居电商摄影图，构图干净、主体明确、可直接用于商品展示。
18. 光影、比例、透视、地面接触关系必须真实，避免悬浮感、抠图感和塑料质感。
`,
    });
