...
14. 远景/中景/近景必须通过真实摄影机距离、焦段、机位高度、景深和裁切范围来区分，不能只把沙发简单放大或缩小：
   - 远景：相机后退到房间入口/对角线位置，广角完整展示空间，沙发占比小但完整。
   - 中景：相机在沙发前方约2-3米，标准焦段，沙发为主体并保留地面接触和背景。
   - 近景：相机靠近沙发约0.8-1.4米，中长焦浅景深，突出材质细节，可自然裁切但保留地面接触边缘。
15. 不要把大沙发摆在大窗正前方或房间中央来挡住采光和通道；不要为了拍到沙发正面而把电视墙、窗户、门洞或墙体关系换边；不要让沙发面向窗户却背离已有电视/媒体墙，除非房间参考图明确没有电视/媒体墙。
