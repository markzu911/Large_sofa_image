...
2. 如果房间参考图里已有沙发/座椅，最高优先级是用产品沙发替换原沙发/原座位区，保持原来的会客关系、朝向、离茶几/电视/墙面的距离和通行动线，不要另找空地。
3. 再选择当前景别对应的相机机位：${shotName}。只允许移动相机、改变焦段、机位高度、景深和裁切；拍摄角度可以正面、侧面、背侧或斜侧自适应，不固定。
4. 最后融合产品沙发本体。不要为了画面居中、商品正面角度、近景放大或构图美观，把沙发重新放到窗前、房间中央、门洞、通道、电视所在墙同侧、电视下方、电视旁边贴墙区或固定柜体前。
