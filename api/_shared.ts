...
输入边界必须绝对清楚：
- 【房间参考图】是唯一空间来源。只从它读取墙体、窗户、门洞、电视/媒体墙、固定柜体、地面透视、光线、原家具和通道。
...
- TV 几何硬约束：
  - 如果电视/媒体墙在画面左侧墙，电视所在左半区和电视下方/旁边贴墙区全部 0 分；除非房间透视明确相反，产品沙发中心必须避开 X<50% 的电视同侧区，优先在 X=55%-85%、Y=48%-82% 的右半部/右下/中下观看区，主坐面朝左/左上看电视。
  - 如果电视/媒体墙在画面右侧墙，电视所在右半区和电视下方/旁边贴墙区全部 0 分；除非房间透视明确相反，产品沙发中心必须避开 X>50% 的电视同侧区，优先在 X=15%-45%、Y=48%-82% 的左半部/左下/中下观看区，主坐面朝右/右上看电视。
