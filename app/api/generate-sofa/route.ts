...
【电视墙几何硬约束】
1. 如果电视/媒体墙在画面左侧墙：电视所在左半区、电视下方、电视旁边同墙贴墙区全部禁放；除非房间透视明确相反，产品沙发中心必须避开 X<50% 的电视同侧区，优先落在画面右半部或右下/中下观看区，主坐面朝左/左上看电视。
2. 如果电视/媒体墙在画面右侧墙：电视所在右半区、电视下方、电视旁边同墙贴墙区全部禁放；除非房间透视明确相反，产品沙发中心必须避开 X>50% 的电视同侧区，优先落在画面左半部或左下/中下观看区，主坐面朝右/右上看电视。
3. 如果电视/媒体墙在画面后墙/上方背景墙：电视下方和后墙同侧贴墙区禁放；产品沙发中心应落在画面下方前景观看区，主坐面朝后墙/上方看电视。
4. 只要沙发背靠或贴近电视所在墙、位于电视下方、位于电视旁边同墙贴墙区、或主坐面没有朝向电视，都属于错误落位。不要生成这种画面。
...
3. 如果房间参考图里已有沙发/座椅，先判断原座位区是否是最合理落点。若是，产品沙发替换原座位；若不是，可选择更合理空位，但必须说明并遵守真实会客关系、朝向、离茶几/电视/墙面的距离和通行动线。
4. 再选择当前景别对应的相机机位：${shotName}。只允许移动相机、改变焦段、机位高度、景深和裁切；拍摄角度可以正面、侧面、背侧或斜侧自适应，不固定。
5. 最后融合产品沙发本体。不要为了画面居中、商品正面角度、近景放大或构图美观，把沙发重新放到原座位前方、窗前、房间中央、门洞、通道、电视所在墙同侧、电视下方、电视旁边贴墙区或固定柜体前。
6. 如果窗前是主要采光面或落地窗/窗帘区域，窗前空地不是默认沙发区；除非落位方案明确允许，否则必须保留采光和通行。
7. 如果房间有电视/媒体墙，沙发必须落在电视对侧或斜对侧的观看区，主坐面朝向电视/媒体墙；禁止把沙发放在电视所在墙、电视下方、电视旁边同墙贴墙区或与电视同侧贴墙。
8. 如果电视/媒体墙在画面左侧墙，沙发必须避开左半区电视墙，优先落在画面右半部或右下/中下开阔地并朝左；如果电视/媒体墙在画面右侧墙，沙发必须避开右半区电视墙，优先落在画面左半部或左下/中下开阔地并朝右；如果电视/媒体墙在后墙，沙发必须避开后墙电视下方，优先落在画面下方前景可用地面并朝后墙。
9. 绝对禁止结果：产品沙发被随意放在前景/房间中央/原沙发前方，导致挡通道、挡视线、和原家具拥挤冲突。保留原家具本身不是错误，错误是产品沙发没有合理功能位置。
10. 绝对禁止结果：为了电商主图把沙发实际坐向转成朝镜头，导致它没有面向电视/茶几/会客中心。镜头可以动，沙发坐向不能为了镜头乱转。
11. 绝对禁止结果：电视在左墙却把沙发放在左墙电视旁/电视下方/电视同侧，电视在右墙却把沙发放在右墙电视旁/电视下方/电视同侧，或电视在后墙却把沙发贴在电视下方。
12. 绝对禁止结果：把产品图中的茶几、玩偶/公仔、灯、柜体、画作、地毯、餐桌、窗帘或背景墙复制到目标房间，或让它们影响目标房间落位。
...
- 近景：产品沙发仍在唯一锁定落点，相机靠近拍扶手/坐垫/靠背/缝线/材质，可以自然裁切局部；不能把完整沙发整体巨大化，也不能重新选择窗前、通道、房间中央或旧沙发前方作为背景。

【景别与机位】
1. 远景/中景/近景共用同一个物理落位；差异来自摄影机，而不是沙发换位置或换大小贴图。
2. 摄影机可以从正面、侧面、背侧或斜侧拍摄，角度由合理落位和产品展示共同决定；相机角度与沙发主坐面朝向分开处理，不能用相机正面需求改变沙发坐向。
  ...
  try {
    ...
    try {
      ({ generatedBase64, mimeType, modelUsed, infoText } = await generateImageWithGemini({
        parts: [
          { text: '【产品参考图 - 商品身份最高优先级】必须复刻这同一件沙发本体。先在脑中抠出沙发本体，只提取轮廓、结构、模块数量、扶手/靠背/坐垫形态、缝线、扣点、褶皱、材质纹理、原本颜色和真实固定附属物；这不是风格参考，禁止生成相似款或改款。除非产品图中清晰固定在沙发本体上，否则严禁新增任何文字、Logo、品牌名、商标、图案、刺绣、标签、抱枕、靠包、毯子或装饰。必须忽略并禁止复制这张图里的房间背景、墙面文字、柜墙/柜体、灯具、茶几、玩偶/公仔、地毯、餐桌、画作、窗帘、绿植、水印和所有其他非沙发物体。' },
