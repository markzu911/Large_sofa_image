...
7. 如果房间有电视/媒体墙，沙发必须落在电视对侧或斜对侧的观看区，主坐面朝向电视/媒体墙；禁止把沙发放在电视所在墙、电视下方或与电视同侧贴墙。
8. 如果电视/媒体墙在画面左侧墙，沙发应优先落在画面右半部或右下/下方开阔地并朝左；如果电视/媒体墙在画面右侧墙，沙发应优先落在画面左半部或左下/下方开阔地并朝右；如果电视/媒体墙在后墙，沙发应优先落在画面下方前景可用地面并朝后墙。
9. 远景/中景/近景共用同一个物理落位，通过相机距离、焦段、机位高度、景深和裁切区分；可以正面、侧面、背侧或斜侧拍摄，但不要为了角度改变沙发落位或房间构造。
10. 近景是靠近已落位沙发拍局部材质和结构，可以自然裁切，不是把完整沙发整体巨大化后塞进窗前或房间中央。
11. 沙发必须贴合地面透视，底座/脚部有明确接触点、接触阴影和投射阴影；光影、比例、材质质感真实。
12. 如果用户只用文字描述，就按文字生成高端家居电商摄影图，构图干净、主体明确、可直接用于商品展示。
`,
    });
