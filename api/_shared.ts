...
决策规则：
- 最高优先级：如果房间参考图已有沙发、座椅、贵妃位或明确会客座位，产品沙发必须优先替换原座位区，保持原座位的墙体依靠关系、主坐面朝向、与茶几/地毯/电视/通道的关系；不能因为窗前、房间中央或画面中心有空地就重新选择位置。
...
- 如果房间已有原沙发/座椅/地毯/茶几会客区，优先用商品沙发替换原座位家具或落在同一会客逻辑区域，只有原座位区尺寸明显无法容纳产品时，才允许在同一会客区内轻微平移或调整角度。
