...
13. 近景是靠近已合理落位的产品沙发拍局部材质和结构，可以自然裁切，不是把完整沙发整体巨大化后塞进窗前、房间中央或原沙发前方；保留原家具时也不能让它成为混乱背景或造成双主沙发冲突。
14. 沙发必须贴合地面透视，底座/脚部有明确接触点、接触阴影和投射阴影；光影、比例、材质质感真实。
15. 绝对禁止结果：产品沙发被随意放在前景/房间中央/原沙发前方，导致挡通道、挡视线、和原家具拥挤冲突。保留原家具本身不是错误，错误是产品沙发没有合理功能位置。
16. 沙发主坐面必须朝向电视/茶几/会客中心。相机可以从正面、侧面、背侧或斜侧拍，但不能为了看到商品正面而旋转沙发，使它背离电视/茶几或只面向镜头。
17. 大沙发优先落在稳定家具区：原座位区、电视对侧观看区、地毯/茶几后侧、靠墙开阔区或明确会客边界。除非原房间本来就是岛式沙发布局且四周通道充足，否则不要孤立摆在画面中央或前景。
18. 中景/近景通过相机靠近、焦段和裁切实现，不允许把完整大沙发物理放大并拖到前景。
19. 如果用户只用文字描述，就按文字生成高端家居电商摄影图，构图干净、主体明确、可直接用于商品展示。
`,
    });
